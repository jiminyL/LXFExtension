...
@implementation UIImage (LXFToolkit)
...
- (UIImage *)clipImageWithSize:(CGSize)size {
    ...
    CGRect rect = CGRectMake((size.width-self.size.width)/2, (size.height-self.size.height)/2,self.size.width, self.size.height);
...
{
    UIImage *circle = [UIImage imageNamed:@"common_circle.png"];
    ...
    CGRect rect = CGRectMake(-1.f, -0.5f, width-6, height-6);
