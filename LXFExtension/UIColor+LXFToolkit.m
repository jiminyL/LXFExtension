...
@implementation UIColor (LXFToolkit)
...
+ (UIColor *)randomColor
{
    CGFloat red = (CGFloat)((double)arc4random() / ARC4RANDOM_MAX);
    CGFloat green = (CGFloat)((double)arc4random() / ARC4RANDOM_MAX);
    CGFloat blue = (CGFloat)((double)arc4random() / ARC4RANDOM_MAX);
