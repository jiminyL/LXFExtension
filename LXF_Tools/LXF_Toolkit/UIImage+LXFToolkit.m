...
{
//    if (src) {
//        CGFloat scale = src.size.height > src.size.width;
//        if (scale > 1.f) {
//            src = [src getSubImage:CGRectMake((src.size.height - src.size.width), (src.size.height - src.size.width), src.size.width , src.size.width)];
//        }else {
//            src = [src getSubImage:CGRectMake((src.size.width - src.size.height), (src.size.width - src.size.height), src.size.height , src.size.height)];
//        }
//    }
