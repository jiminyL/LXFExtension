...
#import "NSDictionary+LXFNilSafe.h"

@implementation NSObject (LXFSwizzling)
...
@implementation NSDictionary (LXFNilSafe)
...
@implementation NSMutableDictionary (LXFNilSafe)
...
@implementation NSNull (LXFNilSafe)
